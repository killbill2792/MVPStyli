    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <Modal visible={showForm} animationType="slide" presentationStyle="pageSheet">
        <SafeAreaView style={styles.modalContainer}>
          ...
          {/* Color Picker Overlay - Inside form modal to avoid nested modal issues */}
          {showColorPicker && (
              ...
              <View style={styles.colorPickerModalContent}>
                ...
                <View style={{ flex: 1, position: 'relative' }}>
                  ...
                  {formData.image_url ? (
                    ...
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', padding: 40 }}>
                      <Text style={{ color: Colors.textSecondary }}>No product image available</Text>
                    </View>
                  )}
...
const styles = StyleSheet.create({
  ...
  // Crosshair styles - matching fit check
  colorPickerCrosshair: {
    position: 'absolute',
    width: 24,
    height: 24,
    zIndex: 1000,
  ...
  // Magnifier styles - matching fit check
  ...
  colorPickerMagnifierText: {
    color: '#fff',
    fontSize: 10,
    fontWeight: '600',
    textAlign: 'center',
  },
  colorPickerMagnifierTextSmall: {
    color: '#9ca3af',
    fontSize: 8,
    textAlign: 'center',
    marginTop: 2,
  },
  // Color preview container - matching fit check
  ...
  colorPickerPreviewName: {
    color: '#fff',
    fontSize: 16,
    fontWeight: '600',
  },
  colorPickerPreviewHex: {
    color: '#9ca3af',
    fontSize: 12,
    marginTop: 2,
  },
