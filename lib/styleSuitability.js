...
function colorSuitability(user, product) {
  ...
  console.log('🎨 Color decision (attribute-based):', { 
    season,
    undertone: derivedUndertone,
    colorAttrs: colorAttrs ? { temperature: colorAttrs.temperature, clarity: colorAttrs.clarity, lightness: colorAttrs.lightness.toFixed(2) } : null,
    score,
    verdict 
  });
